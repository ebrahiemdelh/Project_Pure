...
(function ($) {
  ...
  (function () {
    ...
    $("dl").on("click", "dt", function () {
      if ($(this).hasClass("active-lab2")) {
        $(this).removeClass("active-lab2").next("dd").slideUp(500);
      } else {
        $(this).addClass("active-lab2").next("dd").slideDown(500);
      }
    });
    ...
    //   if (dd.is(":visible")) {
    //     dd.slideUp(500);
    //     $("dt").removeClass("active-lab2");
    //   } else {
    //     dd.slideDown(500);
    //     $("dt").addClass("active-lab2");
    //   }
    // });
  })();
})(jQuery);
