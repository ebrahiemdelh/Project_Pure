...
(function ($) {
  ...
  (function () {
    ...
    $("dl").on("click", "dt", function () {
      if ($(this).hasClass("active-lab3")) {
        $(this).removeClass("active-lab3").next("dd").slideUp(500);
      } else {
        $(this).addClass("active-lab3").next("dd").slideDown(500);
      }
    });
    ...
    //   if (dd.is(":visible")) {
    //     dd.slideUp(500);
    //     $("dt").removeClass("active-lab3");
    //   } else {
    //     dd.slideDown(500);
    //     $("dt").addClass("active-lab3");
    //   }
    // });
  })();
})(jQuery);
